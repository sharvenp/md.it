<template>
    <div class="bottom-bar">
        <div class="d-flex align-items-center flex-bar">
            <button id="open-button" type="button" title="Open" :disabled="editorLocked" class="btn btn-dark"
                @click="openFile">
            ...
            <button id="save-button" type="button" title="Save" v-show="isIPCSupported" :disabled="editorLocked"
                class="btn btn-dark ms-2" @click="saveFile">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"
                    stroke="currentColor" stroke-width="2">
                    <path stroke-linecap="round" stroke-linejoin="round"
            ...
            <button id="save-as-button" type="button" title="Save As" :disabled="editorLocked" class="btn btn-dark ms-2"
                @click="saveAsFile">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"
                    stroke="currentColor" stroke-width="2">
                    <path stroke-linecap="round" stroke-linejoin="round"
            ...
            <button type="button" id="layout-button" title="Toggle Layout" class="btn btn-dark ms-4" @click="cycleLayout">
            ...
            <button id="spell-check-button" type="button" title="Toggle Spellcheck" :disabled="editorLocked"
                :class="`btn btn-${spellCheck ? 'success' : 'dark'} ms-2`" @click="toggleSpellCheck">
