<template>
    <div class="bottom-bar">
        <div class="d-flex align-items-center bottom-flex-bar">
            <button id="open-button" type="button" title="Open" tabindex="1" :disabled="editorLocked" :class="`btn btn-${buttonColorClass}`"
                @click="openFile">
                <span>Open</span>
            </button>
            <button id="save-button" type="button" title="Save" tabindex="2" v-show="isIPCSupported" :disabled="editorLocked"
            :class="`btn btn-${buttonColorClass} ms-2`" @click="saveFile">
                <span>Save</span>
            </button>
            <button id="save-as-button" type="button" title="Save As" tabindex="3" :disabled="editorLocked" :class="`btn btn-${buttonColorClass} ms-2`"
                @click="saveAsFile">
                <span>Save As</span>
            </button>
            <button type="button" id="layout-button" title="Toggle Layout" tabindex="4" :class="`btn btn-${buttonColorClass} ms-4`" @click="cycleLayout">
            ...
            <button id="spell-check-button" type="button" title="Toggle Spellcheck" tabindex="5" :disabled="editorLocked"
            ...
            <button type="button" id="theme-button" title="Toggle Theme" tabindex="6" :class="`btn btn-${buttonColorClass} ms-2`" @click="toggleTheme">
            ...
            <button type="button" id="scroll-link-button" title="Toggle Scroll Link" tabindex="7" :class="`btn btn-${buttonColorClass} ms-2`" @click="toggleScrollLink">
            ...
            <a class="logo ms-auto text-decoration-none noselect" tabindex="8" href="https://github.com/sharvenp/md.it" target="_blank">
                <div class="d-flex">
